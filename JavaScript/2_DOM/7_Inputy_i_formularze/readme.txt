...
Zasady walidacji kart są uproszczone (nie stosować w rzeczywistych projektach!). Jeżeli chcesz poznać prawdziwe zasady walidacji kart kredytowych, to są one opisane np. tutaj: https://en.wikipedia.org/wiki/Bank_card_number https://en.wikipedia.org/wiki/Luhn_algorithm
-----------------------------------------------------------
Zadanie 2
...
Dodatkowo: Hasło ma mieć co najmniej pięć znaków (w tym co najmniej jedną liczbę i jedną literę).
