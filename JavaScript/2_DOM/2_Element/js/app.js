...
document.addEventListener("DOMContentLoaded", function () {
    ...
    /* Zadanie 6
     Wypisz w konsoli wartość atrybutu dataset dla każdego elementu znajdującego się 
     w zmiennej links (pamiętaj o tym, że jest to tablica). */
    ...
    console.log("typ classList: " + typeof banner.classList);

    console.log(banner.className);
    console.log("typ className: " + typeof banner.className);
