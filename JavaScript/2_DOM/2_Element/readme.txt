...
Zadania powinny być rozwiązane w pliku app.js. Pamiętaj, żeby oddzielać zadania komentarzami i pisać czytelny, dobrze sformatowany kod.
...
Przeanalizuj kod HTML i JavaScript tego zadania. Wypisz w konsoli wszystkie wcześniej przygotowane zmienne i ich typy. W przypadku tablic przeiteruj (używając np. pętli for), wypisując wartość i typ dla każdego elementu, który znajduje się w tablicy.
-------------------------------------------------------------
Zadanie 3
...
Wypisz w konsoli wartość atrybutów classList i className dla zmiennej banner. Wypisz w konsoli, jakiego typu (i ewentualnie jakiej klasy) są te wartości.
