...
document.addEventListener("DOMContentLoaded", function () {
    ...
    /* Zadanie 5
     Znajdź wszystkie elementy li, które są w tagu nav. Następnie nadaj każdemu elementowi
     li atrybut data-direction = "top", ale tylko dla tych elementów, które nie mają 
     ustawionego tego atrybutu. */

    var allLiInNavWithoutData = document.querySelectorAll("nav ul li:not([data-direction])");
    console.log("allLiInNavWithoutData: " + allLiInNavWithoutData.length);
    
    for (var i = 0; i < allLiInNavWithoutData.length; i++) {
        allLiInNavWithoutData[i].setAttribute("data-direction", "top");
    }
