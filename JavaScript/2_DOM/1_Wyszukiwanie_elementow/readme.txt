...
Zadania powinny być rozwiązane w pliku app.js. Pamiętaj, żeby oddzielać zadania komentarzami i pisać czytelny, dobrze sformatowany kod. Nie modyfikuj kodu HTML, chyba że w poleceniu jest napisane inaczej.
...
Wyszukaj na stronie i zapisz do zmiennej element o id exercise2, który znajduje się w menu. Skorzystaj z selektora CSS. Nie odwołuj się bezpośredniego do klasy lub id jakiegokolwiek elementu. Użyj selektorów potomków, dzieci, n-tych dzieci itp.
