...
Napisz prosty schemat pytań i odpowiedzi. Docelowo odpowiedzi mają być niewidoczne. Powinny ukazywać się dopiero po kliknięciu na pytanie. 

---------------------------------------------------------
Punkt 1

Zapoznaj się z kodem HTML i CSS dodanym do zadania. Wszystkie pytania i odpowiedzi są w divie – któremu dodaj odpowiednią klasę.
---------------------------------------------------------
Punkt 2
...
Znajdź następujące elementy i zapisz je do zmiennych:
    ...
    Wszystkie pytania (czyli elementy h1).
    wszystkie odpowiedzi (czyli elementy p).
...
Spowoduj, aby tylko jedna z odpowiedzi była widoczna na ekranie – ta kliknięta. W celu uzyskania takiego efektu napisz w evencie kod powodujący, że wszystkie paragrafy znikną (poza tym przypisanym do klikniętego pytania). Zachowanie paragrafu przypisanego do pytania się nie zmienia.
---------------------------------------------------------
Punkt 6
