...
Zapoznaj się dokładnie z kodem HTML dodanym do zadania. Do elementu form w odpowiednim atrybucie dopisz adres, pod który chcemy wysłać formularz.
-----------------------------------------------------------------
Punkt 2
...
Po kliknięciu w przycisk submit powinny być wykonane następujące kroki:
    ...
    Sprawdź każdą wprowadzoną wartość przez użytkownika w następujący sposób:
