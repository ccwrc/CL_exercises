...
Przygotuj do pracy plik app.js. Dopisz event DomContentLoaded i sprawdź, czy działa (np. przez wyświetlenie w konsoli napisu "Działa"). Następnie znajdź następujące elementy i zapisz je do zmiennych:
...
Po kliknięciu na obrazek powinien nam się wyświetlać powiększony obrazek + guzik. Dopisz event reagujący na kliknięcie w guzik. Ma on spowodować usunięcie nowo stworzonego elementu z drzewa DOM.
----------------------------------------------------------------
Punkt 7
