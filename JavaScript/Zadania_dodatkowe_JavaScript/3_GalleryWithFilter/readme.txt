...
Przygotuj do pracy plik app.js. Dopisz event DomContentLoaded i sprawdź, czy działa (np poprzez wyświetlenie w konsoli napisu "Działa"). Następnie znajdź następujące elementy i zapisz je do zmiennych:
    ...
    Input, do którego bedziemy wprowadzać tagi.
