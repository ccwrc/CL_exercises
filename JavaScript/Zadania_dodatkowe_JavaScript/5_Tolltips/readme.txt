...
Tekst, który ma się wyświetlić w tooltipie, powinien być trzymany w data-secie. Zadanie podzielone jest na punkty. Pamiętaj, żeby trzymać się dokładnie treści punktów i robić je po kolei.
...
Przygotuj do pracy plik app.js. Dopisz event DomContentLoaded i sprawdź, czy działa (np poprzez wyświetlenie w konsoli napisu "Działa"). Następnie znajdź elementy o klasie tooltip (pamiętaj, że może być ich wiele) i zapisz je do zmiennych. Wypisz zmienne w konsoli, żeby upewnić się, czy zawierają poprawne dane.
------------------------------------------------------------
Punkt 3
